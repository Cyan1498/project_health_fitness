package com.grupoc.project_health_fitness.view
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            ...
            // Aquí puedes continuar con el resto del código de tu MainActivity
            // Cargar la animación del logo en el LoginFragment
            //val loginFragment = supportFragmentManager.findFragmentByTag("LoginFragment") as LoginFragment?
            // loginFragment?.loadLogoAnimation(R.raw.logo_animation) // Reemplaza "logo_animation" con el ID de tu animación de logo
